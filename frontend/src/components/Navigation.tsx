...
export default function Navigation() {
  ...
  useEffect(() => {
    ...
    if (activeButton) {
      ...
      setIndicatorStyle({
        left: offsetLeft - 15, // because padding-inline is 15
        width: offsetWidth + 30, // 15px left + 15px right
      });
    }
  }, [pathname]);
  ...
  return (
    <nav className="bg-[#1B1A1F] w-full h-[39px] flex justify-center items-center">
      <div
        ref={containerRef}
        className="relative flex justify-center items-center gap-[32px] max-w-[90vw] px-4 h-[39px]"
      >
