...
const PlayerRow = ({ player, status, score, onClick, showCheck, showTrophy, hintName }: PlayerRowProps) => {
  ...
  // Добавляем классы модификаторы. Базовый playerRow уже имеет стиль "неактивной ячейки".
...
export const BracketMatchCard = ({
  ...
  if (isChampion) {
      // Используем те же стили CSS классов для чемпиона, чтобы градиенты совпадали
      return (
